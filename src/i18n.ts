...
const enUS = {
  ...
  hideHistoryTitle: "Hide recent history",
  showHistoryTitle: "Show recent history",
  onboardingTitle: "Welcome to QuickCalc",
  onboardingDescription: "A fast calculator that stays out of your way.",
  onboardingStepHotkey: "Press {hotkey} from anywhere to show or hide QuickCalc.",
  onboardingStepCalculate: "Enter an expression and press Enter. Press Enter again on an empty input to copy the result.",
  onboardingStepCommands: "Use /help to view commands. /exit or /quit hides the window; /shutdown closes QuickCalc completely.",
  onboardingStart: "Start using QuickCalc",
  variables: "Variables",
  ...
  exitSummary: "Hide the QuickCalc window",
  exitUsage: "/exit",
  exitTitle: "QuickCalc hidden",
  exitDone: "Use the global shortcut to show it again.",
  shutdownSummary: "Close QuickCalc completely",
...
const zhCN: Messages = {
  ...
  hideHistoryTitle: "收起最近历史记录",
  showHistoryTitle: "展开最近历史记录",
  onboardingTitle: "欢迎使用 QuickCalc",
  onboardingDescription: "一个随叫随到、专注计算的快速计算器。",
  onboardingStepHotkey: "在任意位置按 {hotkey} 即可显示或隐藏 QuickCalc。",
  onboardingStepCalculate: "输入表达式后按 Enter 计算；输入为空时再次按 Enter 可复制结果。",
  onboardingStepCommands: "输入 /help 查看命令。/exit 或 /quit 隐藏窗口；/shutdown 彻底关闭 QuickCalc。",
  ...
  exitSummary: "隐藏 QuickCalc 窗口",
  exitUsage: "/exit",
  exitTitle: "QuickCalc 已隐藏",
  exitDone: "使用全局快捷键可再次显示。",
  shutdownSummary: "彻底关闭 QuickCalc",
  shutdownUsage: "/shutdown",
...
const zhTW: Messages = {
  ...
  hideHistoryTitle: "收合最近歷史記錄",
  showHistoryTitle: "展開最近歷史記錄",
  onboardingTitle: "歡迎使用 QuickCalc",
  onboardingDescription: "一個隨叫隨到、專注計算的快速計算機。",
  onboardingStepHotkey: "在任何位置按 {hotkey} 即可顯示或隱藏 QuickCalc。",
  onboardingStepCalculate: "輸入運算式後按 Enter 計算；輸入為空時再次按 Enter 可複製結果。",
  onboardingStepCommands: "輸入 /help 查看指令。/exit 或 /quit 隱藏視窗；/shutdown 徹底關閉 QuickCalc。",
  ...
  exitSummary: "隱藏 QuickCalc 視窗",
  exitUsage: "/exit",
  exitTitle: "QuickCalc 已隱藏",
  exitDone: "使用全域快捷鍵可再次顯示。",
  shutdownSummary: "徹底關閉 QuickCalc",
  shutdownUsage: "/shutdown",
