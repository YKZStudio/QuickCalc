...
const enUS = {
  ...
  interactionHint: "Enter calculate · ↑↓ history · /help help · Esc hide",
  ...
  helpExpression:
    "Expressions: press Enter to evaluate, empty Enter to copy, and Up/Down to browse history or return to the current draft.",
  helpBaseConversion:
  ...
  deleteSummary: "Delete a saved user variable",
  deleteUsage: "/del <variable>",
  deleteArgumentsInvalid: "/del requires exactly one variable name",
  deleteBuiltinDenied: "Built-in variable or constant {name} cannot be deleted",
  deleteNotFound: "Variable not found: {name}",
  deleteTitle: "Variable deleted",
  deleteRemoved: "Deleted variable {name}.",
  deleteVariableTitle: "Delete variable {name}",
...
const zhCN: Messages = {
  ...
  waiting: "等待输入",
  interactionHint: "Enter 计算 · ↑↓ 历史 · /help 帮助 · Esc 隐藏",
  ...
  helpExpression: "表达式：按 Enter 求值，空输入时按 Enter 复制；上/下键浏览历史并返回当前草稿。",
  helpBaseConversion:
  ...
  deleteSummary: "删除已保存的用户变量",
  deleteUsage: "/del <变量名>",
  deleteArgumentsInvalid: "/del 需要且只能提供一个变量名",
  deleteBuiltinDenied: "内置变量或常量 {name} 不可删除",
  deleteNotFound: "没有找到变量：{name}",
  deleteTitle: "变量已删除",
  deleteRemoved: "已删除变量 {name}。",
...
const zhTW: Messages = {
  ...
  waiting: "等待輸入",
  interactionHint: "Enter 計算 · ↑↓ 歷史 · /help 說明 · Esc 隱藏",
  ...
  helpExpression: "運算式：按 Enter 求值，空輸入時按 Enter 複製；上/下鍵瀏覽歷史並返回目前草稿。",
  helpBaseConversion:
  ...
  deleteSummary: "刪除已儲存的使用者變數",
  deleteUsage: "/del <變數名稱>",
  deleteArgumentsInvalid: "/del 需要且只能提供一個變數名稱",
  deleteBuiltinDenied: "內建變數或常數 {name} 不可刪除",
  deleteNotFound: "找不到變數：{name}",
  deleteTitle: "變數已刪除",
  deleteRemoved: "已刪除變數 {name}。",
  deleteVariableTitle: "刪除變數 {name}",
